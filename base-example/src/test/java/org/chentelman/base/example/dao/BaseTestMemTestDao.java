...
@Component
public class BaseTestMemTestDao extends BaseTestDaoImpl<BaseTestEntity, Long> {

	public BaseTestMemTestDao(BaseTestMemDao dao, BaseObjectService builderService) {

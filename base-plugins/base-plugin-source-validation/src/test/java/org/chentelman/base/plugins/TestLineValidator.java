package org.chentelman.base.plugins;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertFalse;
import static org.junit.Assert.assertTrue;

import org.chentelman.base.plugins.validation.source.LineValidator;
import org.chentelman.base.plugins.validation.source.LineValidatorTestCaseSetup;
...
public class TestLineValidator extends LineValidatorTestCaseSetup {
	...
	@Test public void validateEmptyLine_ts   () { validateEmptyLine (  "ts"); }
	...
	@Test public void validateNonEmptyLine_ts   () { validateNonEmptyLine (  "ts"); }
	...
	@Test public void validateTrailingSpace_ts   () { validateTrailingSpace (  "ts",  true); }
	...
	@Test public void validateLeadingSpace_ts   () { validateLeadingSpace (  "ts",  true); }
	...
	@Test public void validateMiddleTabs_ts   () { validateMiddleTabs (  "ts"); }
	...
	@Test public void validateWhiteSpaceLine_ts   () { validateWhiteSpaceLine (  "ts",  true,  true); }
	...
	@Test public void validateJavaDocLine_ts   () { validateJavaDocLine (  "ts",  true); }

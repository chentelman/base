...
@RestController
@RequestMapping("/BaseTestMemDefaultConvertController")
public class BaseTestMemDefaultConvertController extends BaseConvertControllerImpl<Long, BaseTestCreate, BaseTestDetails, BaseTestSummary, BaseTestUpdate, BaseTestEntity> {

	protected BaseTestMemDefaultConvertController(BaseTestMemDefaultService service) {
		super(service);
	}

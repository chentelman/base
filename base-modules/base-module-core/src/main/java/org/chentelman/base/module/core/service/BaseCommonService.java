...
/**
 * A common super interface for all base sevice interfaces.
 * This is used to match any of the supported service's for autowire purposes
 *
 ...
 */
public interface BaseCommonService<E extends BaseEntity<I>, I> {

Feature: In memory partitioned Data Entity CRUD operations
	I want to be able to persist in memory partitioned entities

	Background:
		Given all "TestPartitionedEntity" data entries

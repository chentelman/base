...
@RestController
@RequestMapping("/BaseTestMemPartitionedConvertConvertController")
public class BaseTestMemPartitionedConvertConvertController extends BasePartitionedConvertControllerImpl<Long, String, BaseTestCreate, BaseTestDetails, BaseTestSummary, BaseTestUpdate, BaseTestDomain> {

	protected BaseTestMemPartitionedConvertConvertController(BaseTestMemPartitionedConvertService service) {
		super(service);
	}

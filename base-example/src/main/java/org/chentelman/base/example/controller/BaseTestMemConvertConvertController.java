...
@RestController
@RequestMapping("/BaseTestMemConvertConvertController")
public class BaseTestMemConvertConvertController extends BaseConvertControllerImpl<Long, BaseTestCreate, BaseTestDetails, BaseTestSummary, BaseTestUpdate, BaseTestDomain> {

	protected BaseTestMemConvertConvertController(BaseTestMemConvertService service) {
		super(service);
	}

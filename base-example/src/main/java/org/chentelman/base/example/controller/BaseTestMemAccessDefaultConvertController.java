...
@RestController
@RequestMapping("/BaseTestMemAccessDefaultConvertController")
public class BaseTestMemAccessDefaultConvertController extends BaseConvertControllerImpl<Long, BaseTestCreate, BaseTestDetails, BaseTestSummary, BaseTestUpdate, BaseTestEntity> {

	protected BaseTestMemAccessDefaultConvertController(BaseTestMemAccessDefaultService service) {
		super(service);
	}

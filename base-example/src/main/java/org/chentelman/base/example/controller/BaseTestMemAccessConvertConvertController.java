...
@RestController
@RequestMapping("/BaseTestMemAccessConvertConvertController")
public class BaseTestMemAccessConvertConvertController extends BaseAccessConvertControllerImpl<BaseTestDomain, BaseTestDetails, BaseTestSummary, Long> {

	protected BaseTestMemAccessConvertConvertController(BaseTestMemAccessConvertService service) {
		super(service);
	}
